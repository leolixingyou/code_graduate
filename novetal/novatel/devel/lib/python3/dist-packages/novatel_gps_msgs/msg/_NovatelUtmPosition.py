...
"""autogenerated by genpy from novatel_gps_msgs/NovatelUtmPosition.msg. Do not edit."""
import codecs
import sys
...
class NovatelUtmPosition(genpy.Message):
  _md5sum = "401ec19560e710c1e0aab9f0eec02ece"
  _type = "novatel_gps_msgs/NovatelUtmPosition"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Parsed Best UTM data from Novatel OEM6 receiver
Header header
...
bool glonass_L2_used_in_solution"""
  ...
  _slot_types = ['std_msgs/Header','novatel_gps_msgs/NovatelMessageHeader','string','string','uint32','string','float64','float64','float64','float32','string','float32','float32','float32','string','float32','float32','uint8','uint8','uint8','uint8','novatel_gps_msgs/NovatelExtendedSolutionStatus','novatel_gps_msgs/NovatelSignalMask']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,novatel_msg_header,solution_status,position_type,lon_zone_number,lat_zone_letter,northing,easting,height,undulation,datum_id,northing_sigma,easting_sigma,height_sigma,base_station_id,diff_age,solution_age,num_satellites_tracked,num_satellites_used_in_solution,num_gps_and_glonass_l1_used_in_solution,num_gps_and_glonass_l1_and_l2_used_in_solution,extended_solution_status,signal_mask
    ...
    """
    if args or kwds:
      super(NovatelUtmPosition, self).__init__(*args, **kwds)
      ...
      if self.position_type is None:
        self.position_type = ''
      if self.lon_zone_number is None:
        self.lon_zone_number = 0
      if self.lat_zone_letter is None:
        self.lat_zone_letter = ''
      ...
      if self.datum_id is None:
        self.datum_id = ''
      if self.northing_sigma is None:
        self.northing_sigma = 0.
      if self.easting_sigma is None:
        self.easting_sigma = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.lon_zone_number
      buff.write(_get_struct_I().pack(_x))
      _x = self.lat_zone_letter
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3df().pack(_x.northing, _x.easting, _x.height, _x.undulation))
      _x = self.datum_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3f().pack(_x.northing_sigma, _x.easting_sigma, _x.height_sigma))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.lon_zone_number,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.lat_zone_letter = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.lat_zone_letter = str[start:end]
      _x = self
      start = end
      end += 28
      (_x.northing, _x.easting, _x.height, _x.undulation,) = _get_struct_3df().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.northing_sigma, _x.easting_sigma, _x.height_sigma,) = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
