...
"""autogenerated by genpy from novatel_gps_msgs/Gprmc.msg. Do not edit."""
import codecs
import sys
...
class Gprmc(genpy.Message):
  _md5sum = "02533bac67f17457b2e3538525ba1aae"
  _type = "novatel_gps_msgs/Gprmc"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','float64','string','float64','float64','string','string','float32','float32','string','float32','string','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,message_id,utc_seconds,position_status,lat,lon,lat_dir,lon_dir,speed,track,date,mag_var,mag_var_direction,mode_indicator
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.utc_seconds,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.position_status = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.position_status = str[start:end]
      _x = self
      start = end
      end += 16
