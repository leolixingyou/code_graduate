...
"""autogenerated by genpy from novatel_gps_msgs/Gpgsv.msg. Do not edit."""
import codecs
import sys
...
int8 snr"""
  ...
  _slot_types = ['std_msgs/Header','string','uint8','uint8','uint8','novatel_gps_msgs/Satellite[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = novatel_gps_msgs.msg.Satellite()
        _x = val1
        start = end
        end += 5
