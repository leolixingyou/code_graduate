...
"""autogenerated by genpy from novatel_gps_msgs/Insstdev.msg. Do not edit."""
import codecs
import sys
...
class Insstdev(genpy.Message):
  _md5sum = "5a3ffc9969b49cd107b55c9843133d1c"
  _type = "novatel_gps_msgs/Insstdev"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# INS PVA standard deviations
...
"""
  ...
  _slot_types = ['std_msgs/Header','novatel_gps_msgs/NovatelMessageHeader','float32','float32','float32','float32','float32','float32','float32','float32','float32','novatel_gps_msgs/NovatelExtendedSolutionStatus','uint16']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,novatel_msg_header,latitude_dev,longitude_dev,height_dev,north_velocity_dev,east_velocity_dev,up_velocity_dev,roll_dev,pitch_dev,azimuth_dev,extended_solution_status,time_since_update
    ...
    if args or kwds:
      ...
      if self.latitude_dev is None:
        self.latitude_dev = 0.
      if self.longitude_dev is None:
        self.longitude_dev = 0.
      if self.height_dev is None:
        self.height_dev = 0.
      if self.north_velocity_dev is None:
        self.north_velocity_dev = 0.
      if self.east_velocity_dev is None:
        self.east_velocity_dev = 0.
      if self.up_velocity_dev is None:
        self.up_velocity_dev = 0.
      if self.roll_dev is None:
        self.roll_dev = 0.
      if self.pitch_dev is None:
        self.pitch_dev = 0.
      if self.azimuth_dev is None:
        self.azimuth_dev = 0.
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.novatel_msg_header.gps_week_num, _x.novatel_msg_header.gps_seconds, _x.novatel_msg_header.receiver_status.original_status_code, _x.novatel_msg_header.receiver_status.error_flag, _x.novatel_msg_header.receiver_status.temperature_flag, _x.novatel_msg_header.receiver_status.voltage_supply_flag, _x.novatel_msg_header.receiver_status.antenna_powered, _x.novatel_msg_header.receiver_status.antenna_is_open, _x.novatel_msg_header.receiver_status.antenna_is_shorted, _x.novatel_msg_header.receiver_status.cpu_overload_flag, _x.novatel_msg_header.receiver_status.com1_buffer_overrun, _x.novatel_msg_header.receiver_status.com2_buffer_overrun, _x.novatel_msg_header.receiver_status.com3_buffer_overrun, _x.novatel_msg_header.receiver_status.usb_buffer_overrun, _x.novatel_msg_header.receiver_status.rf1_agc_flag, _x.novatel_msg_header.receiver_status.rf2_agc_flag, _x.novatel_msg_header.receiver_status.almanac_flag, _x.novatel_msg_header.receiver_status.position_solution_flag, _x.novatel_msg_header.receiver_status.position_fixed_flag, _x.novatel_msg_header.receiver_status.clock_steering_status_enabled, _x.novatel_msg_header.receiver_status.clock_model_flag, _x.novatel_msg_header.receiver_status.oemv_external_oscillator_flag, _x.novatel_msg_header.receiver_status.software_resource_flag, _x.novatel_msg_header.receiver_status.aux1_status_event_flag, _x.novatel_msg_header.receiver_status.aux2_status_event_flag, _x.novatel_msg_header.receiver_status.aux3_status_event_flag, _x.novatel_msg_header.receiver_software_version, _x.latitude_dev, _x.longitude_dev, _x.height_dev, _x.north_velocity_dev, _x.east_velocity_dev, _x.up_velocity_dev, _x.roll_dev, _x.pitch_dev, _x.azimuth_dev, _x.extended_solution_status.original_mask, _x.extended_solution_status.advance_rtk_verified,) = _get_struct_IdI23BI9fIB().unpack(str[start:end])
      ...
      (self.time_since_update,) = _get_struct_H().unpack(str[start:end])
      return self
...
def _get_struct_H():
    ...
    return _struct_H
_struct_IdI23BI9fIB = None
def _get_struct_IdI23BI9fIB():
    global _struct_IdI23BI9fIB
    if _struct_IdI23BI9fIB is None:
        _struct_IdI23BI9fIB = struct.Struct("<IdI23BI9fIB")
    return _struct_IdI23BI9fIB
_struct_If = None
def _get_struct_If():
    global _struct_If
