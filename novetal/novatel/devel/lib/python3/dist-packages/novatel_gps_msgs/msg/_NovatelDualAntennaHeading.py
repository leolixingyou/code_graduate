...
"""autogenerated by genpy from novatel_gps_msgs/NovatelDualAntennaHeading.msg. Do not edit."""
import codecs
import sys
...
class NovatelDualAntennaHeading(genpy.Message):
  _md5sum = "9e80eaa83bf25f057aea59ce70d859e5"
  _type = "novatel_gps_msgs/NovatelDualAntennaHeading"
...
bool glonass_L2_used_in_solution"""
  ...
  _slot_types = ['std_msgs/Header','novatel_gps_msgs/NovatelMessageHeader','string','string','float32','float32','float32','float32','float32','string','uint8','uint8','uint8','uint8','uint8','novatel_gps_msgs/NovatelExtendedSolutionStatus','novatel_gps_msgs/NovatelSignalMask']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NovatelDualAntennaHeading, self).__init__(*args, **kwds)
