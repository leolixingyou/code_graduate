...
# g_img_front_last = np.zeros((268,423,3),dtype=np.uint8)
# g_img_left_last = np.zeros((238,423,3),dtype=np.uint8)
# g_img_right_last = np.zeros((238,423,3),dtype=np.uint8)

g_img_front_last = np.zeros((390,613,3),dtype=np.uint8)
g_img_left_last = np.zeros((349,613,3),dtype=np.uint8)
g_img_right_last = np.zeros((349,613,3),dtype=np.uint8)
...
def overlay_cam_front():
    ...
    myX, myY, myW, myH = 653, 255, 613, 390
...
def overlay_cam_left():
    ...
    myX, myY, myW, myH = 20, 255, 613, 349
...
def overlay_cam_right():
    ...
    myX, myY, myW, myH = 1286, 255, 613, 349
...
def overlay_front_plot():
    global g_list_imu_pitch, g_list_cam_pitch, g_degree_imu, g_degree_cam
    ## hai 
    #  f myX, myY, myW, myH = 750, 255, 423, 268
    #  l myX, myY, myW, myH = 247, 255, 423, 238
    #  r myX, myY, myW, myH = 1267, 255, 423, 238

    myX, myY, myW, myH = 733, 665, 423, 238
    ...
    cv2.putText(g_imgBig,' 10',(733, 690),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'  5',(733, 737),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'  0',(733, 784),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'- 5',(733, 831),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'-10',(733, 878),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'deg',(683, 784),cv2.FONT_HERSHEY_SIMPLEX,0.6,(0,0,0),2,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'-5 sec',(723, 913),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),2,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'0 sec',(1146, 913),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),2,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'recording : ', (1700, 30),cv2.FONT_HERSHEY_SIMPLEX,0.8,(0,0,0),2,lineType=cv2.LINE_AA)
    if recording_toggle:
...
def overlay_left_plot():
    ...
    myX, myY, myW, myH = 100, 665, 423, 238
    if not queue_degrees_imu.empty():
        g_degree_imu = queue_degrees_imu.get()
    if not queue_degrees_cam.empty():
        g_degree_cam = queue_degrees_cam.get()
    ...
    img_plot_small = cv2.resize(img_plot, (myW, myH))
    g_imgBig[myY:myY+myH, myX:myX+myW] = cv2.copyTo(img_plot_small,None)
    cv2.line(g_imgBig,(1366, 665),(1366, 903),(0,0,0),2)
    cv2.line(g_imgBig,(1366, 903),(1789, 903),(0,0,0),2)
    cv2.putText(g_imgBig,' 10',(100, 690),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'  5',(100, 737),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'  0',(100, 784),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'- 5',(100, 831),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'-10',(100, 878),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'deg',(50, 784),cv2.FONT_HERSHEY_SIMPLEX,0.6,(0,0,0),2,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'-5 sec',(90, 913),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),2,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'0 sec',(513, 913),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),2,lineType=cv2.LINE_AA)

def overlay_right_plot():
    global g_list_imu_pitch, g_list_cam_pitch, g_degree_imu, g_degree_cam
    ## hai 
    #  f myX, myY, myW, myH = 750, 255, 423, 268
    #  l myX, myY, myW, myH = 247, 255, 423, 238
    ...
    myX, myY, myW, myH = 1366, 665, 423, 238
    if not queue_degrees_imu.empty():
        g_degree_imu = queue_degrees_imu.get()
    if not queue_degrees_cam.empty():
        g_degree_cam = queue_degrees_cam.get()
    ...
    cv2.line(g_imgBig,(1366, 665),(1366, 903),(0,0,0),2)
    cv2.line(g_imgBig,(1366, 903),(1789, 903),(0,0,0),2)
    cv2.putText(g_imgBig,' 10',(1366, 690),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'  5',(1366, 737),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'  0',(1366, 784),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'- 5',(1366, 831),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'-10',(1366, 878),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),1,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'deg',(1316, 784),cv2.FONT_HERSHEY_SIMPLEX,0.6,(0,0,0),2,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'-5 sec',(1356, 920),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),2,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'0 sec',(1779, 920),cv2.FONT_HERSHEY_SIMPLEX,0.4,(0,0,0),2,lineType=cv2.LINE_AA)
