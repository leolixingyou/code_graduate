...
#################################### draw grid ################
                        ...
                        #     show_frame = cv2.line(show_frame, (int(self.calib.src_leftline_2d[i][0]), int(self.calib.src_leftline_2d[i][1])), \
                        #         (int(self.calib.src_rightline_2d[i][0]), int(self.calib.src_rightline_2d[i][1])), (255,0,0), thickness=1)
                        #     dist = int(i*grid_size)
                        #     show_frame = cv2.putText(show_frame, str(dist), (int(self.calib.src_leftline_2d[i][0]), int(self.calib.src_leftline_2d[i][1])),\
