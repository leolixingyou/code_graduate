    ...
    def main(self):
        try:
            ...
            while not rospy.is_shutdown():
                ...
                if  self.get_new_IMG_msg1:#and self.get_new_IMG_msg2 and self.get_new_IMG_msg3:
                    start = time.time()
...
#####
                    ...
                    try:
                        ...
                        show_frame = self.drawer.draw(orig_im, dets_arr,labels_arr,self.ori_dist_arr,self.dist_arr,[],[], self.GT_dist, (1. / (moving_det + 1e-8)), is_tracker=False)
                    except:
                        show_frame = orig_im
                    ...
                    if len(dets_arr) > 0:
                        bbox_array_msg = self.get_bbox_array_msg(dets_arr, labels_arr, self.sum_img['header'])
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--weightfile', default="./weight/io.pth")
    parser.add_argument('--weightfile', default="./weight/yolov4.pth")
    # parser.add_argument('--weightfile', default="./weight/Yolov4_0331.pth")
    # parser.add_argument('--weightfile', default="./weight/Yolov4s_epoch16_13920.pth")  
