...
def overlay_pose_plot():
    ...
    cv2.putText(g_imgBig,'-5 sec',(800, 1010),cv2.FONT_HERSHEY_SIMPLEX,0.4,(156, 138, 98),2,lineType=cv2.LINE_AA)
    cv2.putText(g_imgBig,'0 sec',(1600, 1010),cv2.FONT_HERSHEY_SIMPLEX,0.4,(156, 138, 98),2,lineType=cv2.LINE_AA)
