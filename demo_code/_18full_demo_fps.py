...
class Mian:
    ...
    def main(self,im_list):
        ...
        im_list = ['../dataset/real_ioniq/dis/60/0.png']
        for img in im_list:
            top_start = time.time()
            ...
            print(f'top_end is {top_end-top_start}')
            print(f'bottom_end is {bottom_end-bottom_start}')
            print(f'main is {top_end-top_start+bottom_end-bottom_start}')
            # frame = draw_gt(frame, dis_list)
...
if __name__=='__main__':
    ...
    im_list = sorted(get_video_list(img_path))[3]
    Mian.main(im_list)
